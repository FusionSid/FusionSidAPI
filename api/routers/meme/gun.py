...
gun = APIRouter(tags=tags_metadata, prefix="/api/meme")
...
async def generate_image(image_url: str):
    ...
    cwd = os.getcwd()
    img = Image.open(f"{cwd}/assets/images/memes/gun.bmp").resize((750, 750))
...
async def generate_gun_image(image_url: str):
